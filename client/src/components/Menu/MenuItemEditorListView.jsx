...
const MenuItemEditorListView = ({
  ...
  `}
      ...
      <div className="flex gap-2 pr-3">
        ...
        <button
          onClick={handleSaveItem}
          className="flex items-center gap-1 px-3 py-1.5 text-sm bg-green-500 text-white rounded-md hover:bg-green-600 transition"
        >
        ...
        <button
          onClick={handleCancelEdit}
          className="flex items-center gap-1 px-3 py-1.5 text-sm border border-gray-300 rounded-md text-gray-600 hover:bg-gray-100 transition"
        >
